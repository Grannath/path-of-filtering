...
@FilterBuilder
class StyleContext
internal constructor(internal var backgroundColor: Color? = null,
...
fun FilterContext.withStyle(style: Style, create: StyleContext.() -> Unit) {
    val context = StyleContext(backgroundColor = style.backgroundColor,
...
fun StyleContext.backgroundColor(red: Int,
                                 blue: Int,
                                 green: Int,
                                 alpha: Int = 255) {
...
fun StyleContext.borderColor(red: Int,
                             blue: Int,
                             green: Int,
                             alpha: Int = 255) {
...
fun StyleContext.textColor(red: Int, blue: Int, green: Int, alpha: Int = 255) {
